...
exports.handler = async (event) => {
  ...
  const ready = Boolean(envOk && checks.database.ok && checks.storage.ok && checks.notifications.ok && checks.sms.ok && checks.google.ok && membersPresent && authLinked && gmailLinked);
