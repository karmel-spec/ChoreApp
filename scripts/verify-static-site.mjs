...
const requiredMarkers = [
  ...
  "updateDeadlineCountdown(child, offset);",
  ...
  "Cloud sync pending: ${error.message}",
  "Future rotations and fairness previews now use the new settings.${cloudWarning}",
  "was deleted from the master chore list by ${currentUser?.name || \"Admin\"}.${cloudWarning}",
  "added by ${currentUser?.name || \"Admin\"} as ${frequency.toLowerCase()} and set to ${notice.toLowerCase()}.${cloudWarning}",
  ...
  "panel.style.setProperty(\"display\", parentHidden ? \"none\" : \"block\", parentHidden ? \"important\" : \"\")",
  "panel.hidden = helperHidden",
  "panel.style.setProperty(\"display\", helperHidden ? \"none\" : \"block\", helperHidden ? \"important\" : \"\")",
  "<h3>Family Photo Feed</h3>",
  "role-hidden",
  "workspace-admin .parent-admin-panel",
  "role-helper .helper-access-panel",
  "applyRoleVisibilityClass",
  "Parent Admin",
  "isParentAdminWorkspace",
  "login-control",
  ".top-strip",
  "Finish by Noon",
  "countdownUntilDeadline",
  "activeChoreDayOffset",
  "Previous Chore Cycle",
  "renderPreviousCycleHistory",
  "renderedChoreDayOffset",
...
const requiredAppIds = [
  ...
  "masterChoreAddForm",
  "addMasterChoreBtn",
  "masterChoreTableScroll",
  "toggleChoreFullscreenBtn",
  "choreTable",
  "forecastList",
  "fairnessList",
  "betaDataAdminForm",
