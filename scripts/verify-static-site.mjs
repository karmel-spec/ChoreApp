...
const requiredMarkers = [
  ...
  "localStorage.setItem(familyPhotoStoreKey, validBackup.familyPhoto)",
...
const requiredGuideMarkers = [
  ...
  "logs the cue with Karmel's number",
  ...
  "finalized reviews, extensions, extension audit events, review reminder cues, helper pay weeks, ingredient requests",
